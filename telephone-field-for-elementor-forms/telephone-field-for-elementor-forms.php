...
if (!defined('ELEMENTOR_TELEPHONE_PLUGIN_PATH')) {
    ...
    add_action('elementor_pro/forms/fields/register', 'yeekit_el_add_new_telephone_field');
    function yeekit_el_add_new_telephone_field($form_fields_registrar)
    {
        require_once(ELEMENTOR_TELEPHONE_PLUGIN_PATH . "fields/telephone.php");
        $form_fields_registrar->register(new \Yeekit_Telephone_Field());
    }
